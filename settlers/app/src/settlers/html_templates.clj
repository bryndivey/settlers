(ns settlers.html-templates
  (:use [io.pedestal.app.templates :only [tfn dtfn tnodes]]))

(defmacro settlers-templates
  []
  ;; Extract the 'hello' template from the template file settlers.html.
  ...
  {:settlers-page (dtfn (tnodes "settlers.html" "hello") #{:id})})
