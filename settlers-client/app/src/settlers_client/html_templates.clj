(ns settlers-client.html-templates
  (:use [io.pedestal.app.templates :only [tfn dtfn tnodes]]))

(defmacro settlers-client-templates
  []
  ;; Extract the 'hello' template from the template file settlers-client.html.
  ...
  ;;
  ;; app/src/settlers_client/rendering.cljs
  ;;
  ...
  {:settlers-client-page (dtfn (tnodes "settlers-client.html" "hello") #{:id})})
