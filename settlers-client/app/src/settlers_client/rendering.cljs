(ns settlers-client.rendering
  (:require [domina :as dom]
            [io.pedestal.app.render.push :as render]
            [io.pedestal.app.render.push.templates :as templates]
            [io.pedestal.app.render.push.handlers.automatic :as d])
  (:require-macros [settlers-client.html-templates :as html-templates]))

;; Load templates.

(def templates (html-templates/settlers-client-templates))
...
(defn render-page [renderer [_ path] transmitter]
  (let [;; The renderer that we are using here helps us map changes to
        ...
        ;; Get the dynamic template named :settlers-client-page
        ...
        html (templates/add-template renderer path (:settlers-client-page templates))]
